    ...
    <div class="page page-campus">
      <el-container>
        <el-header class="listName">
          <h3 class="left">床位管理<span>列表</span></h3>
        </el-header>
                   ...
                   <el-table
                      ...
                      <el-table-column label="操作">
                            <template slot-scope="scope">
                              <el-button size="mini"  @click="handle(scope.$index, scope.row)" v-if="(scope.row.zt == 1)">启用</el-button>
                              <el-button size="mini"
                                type="danger"
                                @click="handle(scope.$index, scope.row)"  v-if="(scope.row.zt == 2)">停用</el-button>
                                <el-button size="mini"
                               
                                @click="handle(scope.$index, scope.row)"  v-if="(scope.row.zt == 3)">启用</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-main>
                        ...
                        <el-form label-position="right" label-width="120px" :model="addForm">
                                <el-form-item label="校区">
                                 ...
                                 <el-form-item label="公寓楼编号">
                                      <el-select v-model="addForm.loubh" placeholder="请选择公寓楼编号" @change="gylbhChange('add')">
                                         <el-option v-for="(item,index) in addLou" :key="index" :label="item.name" :value="item.code"></el-option>
                                      </el-select>
                                 </el-form-item>
                                 <el-form-item label="房间编号" >
                                      <el-select v-model="addForm.fjbh" placeholder="请选择房间编号" @change="repeat()">
                                         <el-option v-for="(item,index) in addRoomSelect" :key="index" :label="item.name" :value="item.code"></el-option>
                                      </el-select>
                                 </el-form-item>
                   ...
                   class="header-left">
                       <span>确定要开始此操作</span>
                        <div slot="footer" class="dialog-footer">
                          ...
                          <el-button type="primary" @click="stopOrStart()" :loading="loading">确 定</el-button>
                        </div>
              </el-dialog>
...
<script>
  ...
  RoomDictionary,BuildStatusDictionary,bedList,stopBed} from '@/api';
