import { BedListMap, AllBuildDictionary, ApartDictionary, CampusDictionary, BuildDictionary ,QuitSs} from '@/api';
export default {
  data() {
    return {
      tableDataList: [],
